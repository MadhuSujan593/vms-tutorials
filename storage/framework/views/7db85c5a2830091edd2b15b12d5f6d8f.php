                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm text-right">
                                        <a href="<?php echo e(route('admin.banners.edit', $banner)); ?>" class="text-indigo-600 hover:text-indigo-900 mr-3">Edit</a>
                                        <form action="<?php echo e(route('admin.banners.destroy', $banner)); ?>" method="POST" class="inline-block" onsubmit="return confirm('Are you sure you want to delete this banner?');">
                                            <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\madhu\OneDrive\Desktop\Projects\vms-tutorials\resources\views/admin/banners/index.blade.php ENDPATH**/ ?>