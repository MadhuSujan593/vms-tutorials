                ...
                <div class="p-6 text-gray-900">
                    <form action="<?php echo e(route('admin.banners.update', $banner)); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" id="title" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" value="<?php echo e(old('title', $banner->title)); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="url" name="redirect_url" id="redirect_url" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" value="<?php echo e(old('redirect_url', $banner->redirect_url)); ?>" required placeholder="https://example.com">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="sort_order" id="sort_order" class="mt-1 block w-32 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" value="<?php echo e(old('sort_order', $banner->sort_order)); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                            <div class="flex items-center">
                                <input type="checkbox" name="is_active" id="is_active" class="h-4 w-4 text-indigo-600 border-gray-400 rounded focus:ring-0 focus:ring-offset-0" <?php echo e(old('is_active', $banner->is_active) ? 'checked' : ''); ?>>
...
<?php endif; ?>
<?php /**PATH C:\Users\madhu\OneDrive\Desktop\Projects\vms-tutorials\resources\views/admin/banners/edit.blade.php ENDPATH**/ ?>