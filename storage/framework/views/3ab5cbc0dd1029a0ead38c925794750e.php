...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Our Courses | VMS Tutorials <?php $__env->endSlot(); ?>
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 pt-8 sm:pt-12 pb-16 sm:pb-24">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <?php $__empty_1 = true; $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <a href="<?php echo e($course->redirect_url); ?>" target="_blank" class="group bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 hover:border-indigo-500/50 hover:shadow-xl transition-all duration-300 flex flex-col h-full overflow-hidden">
                    <div class="aspect-video relative overflow-hidden bg-gray-100 dark:bg-gray-900">
                        <img src="<?php echo e(asset('storage/' . $course->image_path)); ?>" alt="<?php echo e($course->title); ?>" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
...
<?php endif; ?>
<?php /**PATH C:\Users\madhu\OneDrive\Desktop\Projects\vms-tutorials\resources\views/public/courses.blade.php ENDPATH**/ ?>