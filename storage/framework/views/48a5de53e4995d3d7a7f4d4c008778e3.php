...
<?php endif; ?>
                ...
                <div class="mt-16 pt-8 border-t border-gray-100 dark:border-gray-800 flex justify-between items-center gap-4">
                    ...
                    <?php if($prev): ?>
                        <a href="<?php echo e(route('public.tutorial', [$category->slug, $prev->slug])); ?>" class="group flex-1 p-6 rounded-2xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 hover:border-indigo-500 transition-all shadow-sm flex flex-col items-start gap-2">
                    ...
                    <?php if($next): ?>
                        <a href="<?php echo e(route('public.tutorial', [$category->slug, $next->slug])); ?>" class="group flex-1 p-6 rounded-2xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 hover:border-indigo-500 transition-all shadow-sm flex flex-col items-end gap-2 text-right">
