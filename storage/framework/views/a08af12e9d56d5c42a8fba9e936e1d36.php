...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="md:col-span-3">
                                ...
                                <input type="text" disabled class="mt-1 block w-full rounded-md border-gray-200 bg-gray-50 text-gray-500 shadow-sm sm:text-sm cursor-not-allowed" value="<?php echo e($tutorial->slug); ?>">
                            </div>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="content" id="content-editor" rows="20" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500  sm:text-sm"><?php echo e(old('content', $tutorial->content)); ?></textarea>
        ...
        (function() {
            function startEditor() {
                ...
                const easyMDE = new EasyMDE({
                    ...
                    autosave: {
                        enabled: true,
                        uniqueId: "edit_tutorial_<?php echo e($tutorial->id); ?>",
                        delay: 1000,
                    },
                    renderingConfig: {
...
<?php endif; ?>
<?php /**PATH C:\Users\madhu\OneDrive\Desktop\Projects\vms-tutorials\resources\views/admin/tutorials/edit.blade.php ENDPATH**/ ?>