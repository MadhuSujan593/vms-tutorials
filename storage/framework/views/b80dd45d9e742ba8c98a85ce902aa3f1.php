...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center gap-4">
            <a href="<?php echo e(route('admin.users.index')); ?>" class="w-10 h-10 bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-xl flex items-center justify-center text-gray-500 hover:text-indigo-600 transition-all shadow-sm">
...
$message = $__bag->first($__errorArgs[0]); ?>
                                    <p class="text-red-500 text-[10px] font-bold uppercase tracking-wider mt-2 px-1"><?php echo e($message); ?></p>
                                <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="email" name="email" id="email" 
                                    class="w-full bg-gray-50/50 dark:bg-gray-900/40 border-gray-100 dark:border-gray-700 rounded-2xl px-4 py-3 text-sm focus:border-indigo-500 focus:ring-indigo-500 dark:text-white transition-all" 
                                    value="<?php echo e(old('email')); ?>" required placeholder="john@example.com">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="pt-6 border-t border-gray-50 dark:border-gray-700">
                                <label class="inline-flex items-center cursor-pointer group">
                                    <div class="relative">
                                        <input type="checkbox" name="is_admin" value="1" class="sr-only peer" <?php echo e(old('is_admin') ? 'checked' : ''); ?>>
                                        <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-indigo-600"></div>
                                    </div>
                                    <span class="ms-3 text-[10px] font-black text-indigo-600 dark:text-indigo-400 uppercase italic tracking-[0.2em] group-hover:text-indigo-700 dark:group-hover:text-indigo-300 transition-colors">Grant Admin Access</span>
                                </label>
                        ...
                        <div class="mt-10 pt-6 border-t border-gray-50 dark:border-gray-700 flex items-center justify-end gap-4">
                            <a href="<?php echo e(route('admin.users.index')); ?>" class="text-xs font-black text-gray-400 uppercase tracking-widest hover:text-gray-600 transition-colors">Cancel</a>
...
<?php endif; ?>
<?php /**PATH C:\Users\madhu\OneDrive\Desktop\Projects\vms-tutorials\resources\views/admin/users/create.blade.php ENDPATH**/ ?>