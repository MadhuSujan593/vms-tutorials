        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8 relative">
            ...
            <div class="max-w-4xl">
                ...
                <div class="flex flex-wrap gap-4">
                    <a href="{{ route('public.courses') }}" class="px-8 py-4 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-2xl transition-all shadow-lg hover:shadow-indigo-500/25">Explore Courses</a>
                    <a href="{{ route('public.contact') }}" class="px-8 py-4 bg-white dark:bg-gray-800 text-gray-900 dark:text-white font-bold rounded-2xl border border-gray-100 dark:border-gray-700 hover:border-indigo-500 transition-all">Get in Touch</a>
                </div>
            </div>
        </div>
    </div>
