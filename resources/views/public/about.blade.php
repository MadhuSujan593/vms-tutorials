<x-public-layout>
    <x-slot name="title">About Us | VMS Tutorials</x-slot>
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8 relative text-center flex flex-col items-center">
            <nav class="flex mb-10 text-[10px] font-bold uppercase tracking-widest" aria-label="Breadcrumb">
                <ol class="flex items-center space-x-3">
                    <li><a href="{{ route('home') }}" class="text-gray-400 hover:text-indigo-600 transition-colors">Home</a></li>
            ...
            <div class="max-w-3xl">
                ...
                <div class="flex flex-wrap justify-center gap-4">
                    <a href="{{ route('public.courses') }}" class="px-8 py-3.5 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-bold rounded-xl transition-all shadow-lg hover:shadow-indigo-500/25">Explore Courses</a>
                    <a href="{{ route('public.contact') }}" class="px-8 py-3.5 bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm font-bold rounded-xl border border-gray-100 dark:border-gray-700 hover:border-indigo-500 transition-all shadow-sm">Get in Touch</a>
                </div>
            </div>
        </div>
    </div>
