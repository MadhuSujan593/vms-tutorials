        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-3 bg-white dark:bg-gray-800 p-2 px-3 rounded-xl border border-gray-100 dark:border-gray-700">
                ...
                <div class="flex flex-col leading-none text-left">
                    ...
                    <span class="text-xs font-black text-gray-900 dark:text-white leading-none tracking-tight uppercase italic">{{ Auth::user()->name }}</span>
                </div>
            </div>
        </div>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-3xl border border-gray-100 dark:border-gray-700 group hover:border-indigo-500 transition-all duration-300">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-right">
                            ...
                            <h3 class="text-3xl font-black text-gray-900 dark:text-white tracking-tighter">{{ $stats['categories'] }}</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-3xl border border-gray-100 dark:border-gray-700 group hover:border-emerald-500 transition-all duration-300">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-right">
                            ...
                            <h3 class="text-3xl font-black text-gray-900 dark:text-white tracking-tighter">{{ $stats['tutorials'] }}</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-3xl border border-gray-100 dark:border-gray-700 group hover:border-amber-500 transition-all duration-300">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-right">
                            ...
                            <h3 class="text-3xl font-black text-gray-900 dark:text-white tracking-tighter">{{ $stats['active_banners'] }}<span class="text-sm font-bold text-gray-400 ml-1">/{{ $stats['banners'] }}</span></h3>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-3xl border border-gray-100 dark:border-gray-700 overflow-hidden">
                ...
                <div class="p-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
                    ...
                    <!-- New Banner -->
                    <a href="{{ route('admin.banners.create') }}" class="group p-6 bg-white dark:bg-gray-900/20 rounded-2xl border border-gray-50 dark:border-gray-800 hover:border-amber-500 hover:bg-white dark:hover:bg-gray-800 transition-all duration-500 flex flex-col items-center text-center gap-4">
                    ...
                    <!-- Manage Content -->
                    <a href="{{ route('admin.categories.index') }}" class="group p-6 bg-white dark:bg-gray-900/20 rounded-2xl border border-gray-100 dark:border-gray-800 hover:border-emerald-500 hover:bg-white dark:hover:bg-gray-800 transition-all duration-300 flex flex-col items-center text-center gap-4">
                    ...
                    <!-- View Site -->
                    <a href="{{ route('home') }}" target="_blank" class="group p-6 bg-white dark:bg-gray-900/20 rounded-2xl border border-gray-50 dark:border-gray-800 hover:border-gray-500 hover:bg-white dark:hover:bg-gray-800 transition-all duration-300 flex flex-col items-center text-center gap-4">
