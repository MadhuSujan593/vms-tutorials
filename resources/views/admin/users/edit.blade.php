    ...
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-[10px] text-gray-400 font-bold uppercase tracking-[0.2em] mt-1">Update administrator profile</p>
            </div>
        </div>
    </x-slot>
                ...
                <div class="p-8">
                    <form action="{{ route('admin.users.update', $user) }}" method="POST">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="p-6 bg-gray-50/50 dark:bg-gray-900/20 rounded-2xl border border-dashed border-gray-100 dark:border-gray-700">
                                <h4 class="text-[10px] font-black text-indigo-600 dark:text-indigo-400 uppercase tracking-[0.2em] mb-4 italic">Update Security Credentials</h4>
                                <p class="text-[10px] text-gray-400 font-bold uppercase tracking-widest mb-6">Leave blank to keep existing password</p>

                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <!-- Password -->
                                    <div>
                                        <label for="password" class="block text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-2 px-1">New Password</label>
                                        <div x-data="{ show: false }" class="relative">
                                            <input :type="show ? 'text' : 'password'" name="password" id="password" 
                                                class="w-full bg-white dark:bg-gray-900/60 border-gray-100 dark:border-gray-700 rounded-2xl px-4 py-3 pr-12 text-sm focus:border-indigo-500 focus:ring-indigo-500 dark:text-white transition-all">
                                    ...
                                    <!-- Confirm Password -->
                                    <div>
                                        <label for="password_confirmation" class="block text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-2 px-1">Confirm New Password</label>
                                        <div x-data="{ show: false }" class="relative">
