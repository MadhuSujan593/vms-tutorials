                ...
                <div class="p-6 text-gray-900 border-b border-gray-200">
                    <form method="POST" action="{{ route('admin.categories.update', $category) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="url" name="practice_test_link" id="practice_test_link" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 sm:text-sm" value="{{ old('practice_test_link', $category->practice_test_link) }}" placeholder="https://vms-tutorials.com/quizzes/python-advanced">
